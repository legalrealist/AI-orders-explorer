...
REQUIRED_KEYS = {
    ...
    'sanction_types', '_rg_id', 'unverified', 'pending', 'slug', 'ai_tool',
    'last_verified',
}
...
def validate_record(rec, idx=None):
    ...
    if 'pending' in rec and not isinstance(rec['pending'], bool):
        problems.append(f'{where}: pending must be bool')
